...
function BasketTrendChart({
  ...
  // than the fixed card and it spilled over the metric cards below. By driving
  // the viewBox off the measured pixel width AND height, the SVG fills the
  // wrapper 1:1 (no overflow, no distortion) at any panel width.
