...
export const BUNDLES: Bundle[] = [
  // HIGH tier (≈ 95% probability target) — SHORT / MED / LONG horizon ladder
  ...
  { id: "PBU-HIGH-MED",   tier: 90, date: dateLabel(55),  daysLeft: 55,  nav: 0.945, issue: 0.95, change: +1.2, hot: false, resolved: 0, totalLegs: 120, ...genBundleHistories(0.945, "PBU-HIGH-MED") },
  ...
  // LOW tier (≈ 5% probability target — long-shot) — SHORT / MED / LONG ladder
  ...
  { id: "PBU-LOW-MED",    tier: 50, date: dateLabel(50),  daysLeft: 50,  nav: 0.052, issue: 0.05, change: -0.3, hot: false, resolved: 0, totalLegs: 60,  ...genBundleHistories(0.052, "PBU-LOW-MED") },
